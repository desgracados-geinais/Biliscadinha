...
function resourceStart(resource)
	...
	setRuleValue("Author", "Trinity  - MTA Server Development Team")
	setRuleValue("Website", "trinitygaming.netne.net")
...
function makeTGName(thePlayer)
	setPlayerName(thePlayer, "TG.Player."..tostring(math.random(0,9))..tostring(math.random(0,9))..tostring(math.random(0,9))..tostring(math.random(0,9)))
end