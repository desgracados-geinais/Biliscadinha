...
function loadCustomVehProperties(vehID, theVehicle)
	...
	if rowVehCustom then
		...
		if rowVehCustom.brand and rowVehCustom.brand ~= "" then
			hasCustomInfo = true
            exports.anticheat:changeProtectedElementDataEx(theVehicle, "unique", true, true)
		end
	end
	...
	exports.anticheat:changeProtectedElementDataEx(theVehicle, "vehicle_shop_id", vehicleShopID, true)
	
	if toBeSet.brand then
		exports.anticheat:changeProtectedElementDataEx(theVehicle, "brand", toBeSet.brand, true)
		exports.anticheat:changeProtectedElementDataEx(theVehicle, "maximemodel", toBeSet.model, true)
		exports.anticheat:changeProtectedElementDataEx(theVehicle, "year", toBeSet.year, true)
		exports.anticheat:changeProtectedElementDataEx(theVehicle, "carshop:cost", toBeSet.price, true)
		exports.anticheat:changeProtectedElementDataEx(theVehicle, "carshop:taxcost", toBeSet.tax, true)
		exports.anticheat:changeProtectedElementDataEx(theVehicle, "vDoorType", toBeSet.doortype, true)
	end
